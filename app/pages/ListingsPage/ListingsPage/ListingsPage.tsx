...
//               isFilterOpen ? "2" : "3"
//             } lg:grid-cols-${isFilterOpen ? "3" : "3"} gap-6`}
//           >
...
const ListingsPage = () => {
  ...
  const FilterContent = ({ onClose }) => <FilterSidebar onClose={onClose} />;
    ...
    <div className="container mx-auto pt-1">
      <div className="flex">
        ...
        {!isMobile && (
          ...
          >
            {isFilterOpen && <FilterContent onClose={toggleFilter} />}
          </div>
        )}
...
// FilterSidebar Component
const FilterSidebar = ({ onClose, isMobile }) => {
  const [priceRange, setPriceRange] = useState([500, 2500]);
  ...
  return (
    <div className="py-6 px-4 md:pr-6 h-full overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold">Filter</h2>
        {
